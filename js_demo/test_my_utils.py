...
class TestMyUtils(Base):
    ...
    def test_input_clear_click(self):
        ...
        # # ele.clear()
        my_js_utils.input('selenium', self.driver, '#kw')
        sleep(3)
        my_js_utils.clear(self.driver, '#kw')
        sleep(3)
        my_js_utils.input('appium', self.driver, '#kw')
        sleep(3)
        my_js_utils.click(self.driver, '#su')
        sleep(4)

    def test_remove_hight(self):
        self.driver.get("https://www.12306.cn/index/")
        ele = self.driver.find_element_by_css_selector("#train_date")
        my_js_utils.height_light(self.driver, "#train_date")
        sleep(2)
        # my_utils.remove_attribute("readonly",self.driver,"#train_date")
        my_js_utils.remove_attr(ele, "#train_date", self.driver)
        sleep(2)
        my_js_utils.input("2021-01-01", self.driver, "#train_date")
        sleep(2)
    ...
    def test_scroll(self):
        ...
        my_js_utils.scroll_to_element(self.driver, wyb)
        sleep(10)
        wyb.click()
        sleep(6)
    ...
    def test_window_time(self):
        self.driver.get("https://www.baidu.com")
        time = my_js_utils.get_window_performance_time(self.driver)
        print(time)
